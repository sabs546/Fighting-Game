...
public class ConnectToServer : GlobalEventListener
{
    [SerializeField]
    ...
    //            Instantiate(roomButton, roomListBox.transform).GetComponent<Button>().onClick.AddListener(delegate { roomActions.JoinRoom(); });
    //            i++;
    //        }
    //        targetRoomCount = i;
    //    }
